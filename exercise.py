...
def weather_advice():
    cold = input("Is it cold outside: ").lower();
    raining = input("Is it raining outside: ").lower();
...
def determine_season():
    month = input("Enter the month (Jan, Feb, etc.): ").capitalize()
